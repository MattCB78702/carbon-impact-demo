    ...
    projects: [
      {
        ...
        creditType: "Removal", methodology: "VM0026 sustainable grassland management",
  ...
  share: {
    ...
    exec: {
      ...
      narration: {
        ...
        text: "We kept the discipline that built the Fat Tire program: every tonne verified, every retirement public. What changes this cycle is the story. Instead of a single industrial project type, this portfolio puts 60% of our spend into the landscapes our beer comes from — Montana grazing land, Tribal forest, Washington composting, Colorado cold storage — and adds independently top-rated projects (BeZero A and AA, ICVCM CCP-approved) that survive legal review of every claim we want marketing to make. Blended cost stays inside the band finance approved, with a quarter of the program in removals rather than avoidance only.",
      },
